...
#ifndef __GXL_LIBRETECH_CC_H__
#define __GXL_LIBRETECH_CC_H__
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	"start_autoscript="\
        ...
        "start_mmc_autoscript="\
            "if ${bloader} 0x1020000 /boot/boot.scr; then autoscr 0x1020000; fi"\
            "\0"\
        "start_usb_autoscript="\
            "if fatload usb 0 0x1020000 /boot/boot.scr; then autoscr 0x1020000; fi"\
            "\0"\
	"firstboot=1\0" \
	"upgrade_step=0\0" \
        "jtag=apao\0"\
	...
	"init_display=" \
		"osd open; osd clear; ${bloader} 0x20000000 /boot/boot.bmp; bmp display 0x20000000;bmp scale"\
		"\0"\

#define CONFIG_PREBOOT  \
		 "run init_display"
#define CONFIG_BOOTCOMMAND "run start_autoscript"
