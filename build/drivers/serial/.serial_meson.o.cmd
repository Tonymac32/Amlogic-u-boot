cmd_drivers/serial/serial_meson.o := /opt/gcc-linaro-aarch64-none-elf-4.8-2013.11_linux/bin/aarch64-none-elf-gcc -Wp,-MD,drivers/serial/.serial_meson.o.d  -nostdinc -isystem /opt/gcc-linaro-aarch64-none-elf-4.8-2013.11_linux/bin/../lib/gcc/aarch64-none-elf/4.8.3/include -Iinclude  -I../include -I../arch/arm/include -include ../include/linux/kconfig.h  -I../drivers/serial -Idrivers/serial -D__KERNEL__ -D__UBOOT__ -DCONFIG_SYS_TEXT_BASE=0x01000000 -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -Os -fno-stack-protector -g -fstack-usage -Wno-format-nonliteral -Werror -D__ARM__ -march=armv8-a -mstrict-align -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -fno-common -ffixed-x18 -pipe    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(serial_meson)"  -D"KBUILD_MODNAME=KBUILD_STR(serial_meson)" -c -o drivers/serial/serial_meson.o ../drivers/serial/serial_meson.c

source_drivers/serial/serial_meson.o := ../drivers/serial/serial_meson.c

deps_drivers/serial/serial_meson.o := \
    $(wildcard include/config/m3.h) \
    $(wildcard include/config/serial/stp/bits.h) \
    $(wildcard include/config/serial/prty/type.h) \
    $(wildcard include/config/serial/char/len.h) \
  ...
  ../include/serial.h \
    ...
    $(wildcard include/config/mb86r0x.h) \
    $(wildcard include/config/sys/sc520.h) \
  ...
  ../include/post.h \
    ...
    $(wildcard include/config/sys/ocm/data/addr.h) \
    ...
    $(wildcard include/config/sys/post/spi.h) \
...
drivers/serial/serial_meson.o: $(deps_drivers/serial/serial_meson.o)
