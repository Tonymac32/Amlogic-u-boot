cmd_drivers/display/osd/osd_hw.o := /opt/gcc-linaro-aarch64-none-elf-4.8-2013.11_linux/bin/aarch64-none-elf-gcc -Wp,-MD,drivers/display/osd/.osd_hw.o.d  -nostdinc -isystem /opt/gcc-linaro-aarch64-none-elf-4.8-2013.11_linux/bin/../lib/gcc/aarch64-none-elf/4.8.3/include -Iinclude  -I../include -I../arch/arm/include -include ../include/linux/kconfig.h  -I../drivers/display/osd -Idrivers/display/osd -D__KERNEL__ -D__UBOOT__ -DCONFIG_SYS_TEXT_BASE=0x01000000 -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -Os -fno-stack-protector -g -fstack-usage -Wno-format-nonliteral -Werror -D__ARM__ -march=armv8-a -mstrict-align -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -fno-common -ffixed-x18 -pipe    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(osd_hw)"  -D"KBUILD_MODNAME=KBUILD_STR(osd_hw)" -c -o drivers/display/osd/osd_hw.o ../drivers/display/osd/osd_hw.c

source_drivers/display/osd/osd_hw.o := ../drivers/display/osd/osd_hw.c

deps_drivers/display/osd/osd_hw.o := \
    $(wildcard include/config/aml/canvas.h) \
    $(wildcard include/config/aml/vout.h) \
    $(wildcard include/config/am/video.h) \
    $(wildcard include/config/aml/vout/framerate/automation.h) \
    $(wildcard include/config/post/process/manager.h) \
    $(wildcard include/config/fb/osd2/cursor.h) \
    $(wildcard include/config/am/fb/ext.h) \
  include/config.h \
  ...
  ../drivers/display/osd/osd_canvas.h \
  ../drivers/display/osd/osd_log.h \
...
drivers/display/osd/osd_hw.o: $(deps_drivers/display/osd/osd_hw.o)
