cmd_drivers/mmc/aml_emmc_partition.o := /opt/gcc-linaro-aarch64-none-elf-4.8-2013.11_linux/bin/aarch64-none-elf-gcc -Wp,-MD,drivers/mmc/.aml_emmc_partition.o.d  -nostdinc -isystem /opt/gcc-linaro-aarch64-none-elf-4.8-2013.11_linux/bin/../lib/gcc/aarch64-none-elf/4.8.3/include -Iinclude  -I../include -I../arch/arm/include -include ../include/linux/kconfig.h  -I../drivers/mmc -Idrivers/mmc -D__KERNEL__ -D__UBOOT__ -DCONFIG_SYS_TEXT_BASE=0x01000000 -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -Os -fno-stack-protector -g -fstack-usage -Wno-format-nonliteral -Werror -D__ARM__ -march=armv8-a -mstrict-align -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -fno-common -ffixed-x18 -pipe    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(aml_emmc_partition)"  -D"KBUILD_MODNAME=KBUILD_STR(aml_emmc_partition)" -c -o drivers/mmc/aml_emmc_partition.o ../drivers/mmc/aml_emmc_partition.c

source_drivers/mmc/aml_emmc_partition.o := ../drivers/mmc/aml_emmc_partition.c

deps_drivers/mmc/aml_emmc_partition.o := \
    $(wildcard include/config/ptbl/mbr.h) \
    $(wildcard include/config/cmp/partname.h) \
    $(wildcard include/config/cmp/partmask.h) \
    $(wildcard include/config/mpt/debug.h) \
...
drivers/mmc/aml_emmc_partition.o: $(deps_drivers/mmc/aml_emmc_partition.o)
