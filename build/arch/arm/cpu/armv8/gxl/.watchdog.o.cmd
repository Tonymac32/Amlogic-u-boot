cmd_arch/arm/cpu/armv8/gxl/watchdog.o := /opt/gcc-linaro-aarch64-none-elf-4.8-2013.11_linux/bin/aarch64-none-elf-gcc -Wp,-MD,arch/arm/cpu/armv8/gxl/.watchdog.o.d  -nostdinc -isystem /opt/gcc-linaro-aarch64-none-elf-4.8-2013.11_linux/bin/../lib/gcc/aarch64-none-elf/4.8.3/include -Iinclude  -I../include -I../arch/arm/include -include ../include/linux/kconfig.h  -I../arch/arm/cpu/armv8/gxl -Iarch/arm/cpu/armv8/gxl -D__KERNEL__ -D__UBOOT__ -DCONFIG_SYS_TEXT_BASE=0x01000000 -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -Os -fno-stack-protector -g -fstack-usage -Wno-format-nonliteral -Werror -D__ARM__ -march=armv8-a -mstrict-align -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -fno-common -ffixed-x18 -pipe    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(watchdog)"  -D"KBUILD_MODNAME=KBUILD_STR(watchdog)" -c -o arch/arm/cpu/armv8/gxl/watchdog.o ../arch/arm/cpu/armv8/gxl/watchdog.c

source_arch/arm/cpu/armv8/gxl/watchdog.o := ../arch/arm/cpu/armv8/gxl/watchdog.c

deps_arch/arm/cpu/armv8/gxl/watchdog.o := \
  ../include/common.h \
...
arch/arm/cpu/armv8/gxl/watchdog.o: $(deps_arch/arm/cpu/armv8/gxl/watchdog.o)
